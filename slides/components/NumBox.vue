...
<template>
    ...
    >
        <div
            ...
            "
            class="absolute w-full h-full bg-green-500/30 transition duration-400 ease-in pointer-events-none"
            :class="active ? '!opacity-100 !duration-10' : 'opacity-0'"
        />
        <slot>
            ...
            <div class="absolute w-full h-full flex z-10">
                <div
                    class="m-auto text-2xl leading-0.8em"
                    :class="controls ? 'pl-2' : ''"
                >
                    {{ value }}
                </div>
